   ...
   <div class="content">
      <div class="page-header">
         <div class="page-title">
            <h4>Update Delivery Attendance</h4>
         </div>
      </div>
                            ...
                            <div class="form-group">
                                <label style="font-size:15px;padding-top: 5px;padding-bottom: 2px;">Delivery Boy<span
                                    ...
                                    @foreach ($deliveryboy as $deliveryboys)
                                        <option value="{{ $deliveryboys->id }}"@if ($deliveryboys->id === $Deliveryattendance->deliveryboy_id) selected='selected' @endif>{{ $deliveryboys->name }}</option>
                            ...
                            <table class="table">
                                ...
                                @foreach ($Deliveryattendancedata as $Deliveryattendancedatas)
                                    <tr>
                                                ...
                                                <td>
                                                   <input type="hidden" id="session_id" name="session_id[]" value="{{$Deliveryattendancedatas->session_id}}"/>
                                                   <input type="text"id="sessionname" readonly name="sessionname[]" value="{{$Deliveryattendancedatas->sessionname}}" class="form-control" style="background: #e9ecefad;"/>
                                                </td>
                                                <td>
                                                   <div style="display:flex;">
                                                      <div class="input-group" style="margin-right: 5px;">
                                                         <div class="input-group-text">
                                                               <input class="form-check-input" type="radio" value="Present" id="attendance" {{ $Deliveryattendancedatas->attendance == 'Present' ? 'checked' : '' }}  name="attendance[{{$Deliveryattendancedatas->session_id}}]"
                                                      ...
                                                      <div class="input-group" style="margin-right: 5px;">
                                                         <div class="input-group-text">
                                                               <input class="form-check-input" type="radio" value="Absent" id="attendance" {{ $Deliveryattendancedatas->attendance == 'Absent' ? 'checked' : '' }} name="attendance[{{$Deliveryattendancedatas->session_id}}]"
