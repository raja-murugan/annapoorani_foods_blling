<div class="modal-dialog modal-xl">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="purchaseorderviewLargeModalLabel{{ $datas['unique_key'] }}">Delivery Attendance ({{ date('d-m-Y', strtotime($datas['date']))  }})</h5>
                        ...
                        <div class="col-lg-10 col-10  col-sm-11">
                           <div class="row">
                                       ...
                                       <div class="col-lg-6 col-sm-6 col-12 border">
                                          <span class="" style="vertical-align: inherit;vertical-align: inherit;font-size: 14px;color:#000;font-weight: 700;line-height: 35px; ">Session</span>
                                       </div>
                                       <div class="col-lg-6 col-sm-6 col-12 border">
