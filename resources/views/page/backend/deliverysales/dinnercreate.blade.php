<div class="modal-dialog modal-l">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="myExtraLargeModalLabel">Create Dinner Delivery</h5>
        </div>
                            ...
                            <div class="form-group">
                                <label style="font-size:15px;padding-top: 5px;padding-bottom: 2px;">Session<span
                                    ...
                                    @foreach ($sesionarr as $sessions)
                                        <option value="{{ $sessions->id }}"@if ($sessions->id === 3) selected='selected' @endif>{{ $sessions->name }}</option>
